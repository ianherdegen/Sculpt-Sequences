...
-- This permission allows users to access the admin page and manage all user permissions
...
-- Example: Grant admin permission to user a5502760-13df-454a-862f-78789213f6be
-- UPDATE user_profiles 
-- SET permissions = jsonb_set(
--   COALESCE(permissions, '{}'::jsonb),
--   '{admin}',
